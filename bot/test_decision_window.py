...
PARAM_SETS: dict[str, dict] = {
    ...
    "donchian_ls": {"lookback": 20, "buffer": 0.002, "expected_move_pct": 0.01},
    "ensemble_ls": {"lookbacks": [10, 20, 40, 80], "enter_frac": 0.8, "exit_frac": 0.5,
                    "confirm_bars": 3, "expected_move_pct": 0.01},
