...
const TZ_COUNTRY: Record<string, string> = {
  ...
  "Asia/Riyadh": "SA", "Asia/Bangkok": "TH", "Asia/Kuala_Lumpur": "MY",
  "Asia/Jakarta": "ID", "Asia/Makassar": "ID", "Asia/Manila": "PH",
  "Europe/Zurich": "CH", "Europe/Stockholm": "SE", "Europe/Oslo": "NO",
  "Europe/Copenhagen": "DK",
  "Africa/Johannesburg": "ZA",
  "Pacific/Auckland": "NZ",
  // Exact entries win over the broad America/* -> US prefix fallback below.
  ...
  "America/Tijuana": "MX", "America/Cancun": "MX",
