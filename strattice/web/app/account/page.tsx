...
const KEY_FACTS: [string, string][] = [
  [
    "storage",
    "Encrypted at rest. The plaintext secret exists only long enough to encrypt it.",
  ],
  [
    "display",
    "Never shown back - not to you, not to us, not in any admin view.",
  ],
  [
    "scope",
    "Trading and balance reads only. With withdrawals disabled, funds physically can't leave your account through this key.",
  ],
  [
    "revocation",
    "Delete the key on CoinDCX at any time and the bot goes blind instantly.",
  ],
];
          ...
          <section className="card p-5">
            ...
            <ol className="mt-4 space-y-2.5">
              {(
                [
                  [
                    "Create an API key on CoinDCX",
                    "Account → API dashboard → create a new key.",
                  ],
                  [
                    "Enable trading, disable withdrawals",
                    "The bot needs the first and must never have the second.",
                  ],
                  [
                    "Add our server IP to the key's allowlist",
                    "So the key only works from the machine that runs your bots.",
                  ],
                ] as const
              ).map(([title, hint], i) => (
        ...
        <aside className="space-y-6">
          <div className="overflow-hidden card">
            ...
            <p className="bg-white/[0.03] px-4 py-2.5 font-mono text-[11px] leading-relaxed text-faint">
              turning the bot off stops new entries at the next poll; open
              positions are still managed to their exit.
            </p>
          </div>
          ...
          <div className="overflow-hidden card">
            ...
            <p className="bg-white/[0.03] px-4 py-2.5 font-mono text-[11px] leading-relaxed text-faint">
              enforced in the executor before every order - not settings you can
              forget to turn on.
            </p>
          </div>
        </aside>
