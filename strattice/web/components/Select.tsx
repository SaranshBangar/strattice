    ...
    <div ref={ref} className={["relative", className ?? ""].join(" ")}>
      ...
      {open && (
        <ul
          id={listId}
          role="listbox"
          className="absolute z-50 mt-1 max-h-60 w-full min-w-max max-w-[calc(100vw-2rem)] overflow-auto rounded-md border border-line bg-panel py-1 shadow-xl shadow-black/40"
        >
          {options.map((o, i) => {
