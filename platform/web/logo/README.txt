...
PNG (raster):
  favicon-16/32/48/64/512.png      square app-icon favicons
  favicon-180.png / apple-touch-icon.png   iOS home-screen icon
  strattice-mark-512.png           transparent mark, 512px
  strattice-logo-light-512.png     light-tile logo, 512px

Usage
-----
Drop the favicon files at your web root and paste favicon-snippet.html into <head>.
Prefer the SVG wherever possible; PNGs are for places that need raster.
On white, use the -light variants (#A67F2E) for adequate contrast.
